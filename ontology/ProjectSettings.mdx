---
title: Project settings ontology
description: Reference for the ProjectSettings ontology in Mindbricks, covering basic project metadata, Stripe, AI, CORS, pipeline templates, and integration configuration.
---
