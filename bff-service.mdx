...
>
> This page describes the **classical DataView-oriented BFF service** (`BFFService` + `DataView` patterns).
> If you are working with AI chat/tool orchestration, use the dedicated **MCP-BFF** guide: [MCP-BFF Service](./mcp-bff-service).
