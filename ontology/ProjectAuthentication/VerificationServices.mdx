---
title: VerificationServices
description: Defines user-related verification features such as password resets, two-factor authentication, and contact verification in Mindbricks, including configuration options for email and mobile flows.
---
