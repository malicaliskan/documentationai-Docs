...
Configuration details for API key authentication, mindbricks supports both secret APİ Key and public API Keys. If APIKeyAuth is ebabled and not configuration is given, it will work as an secret API key in bearer
...
| Field                | Description                                                                                                                                                                                                                                                                                                                                                                 |
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| apiKeyType           | Specifies the type of API key to use. This can be either 'secret', 'public', or 'both'. If not set, the default is 'secret'. If you need to use both secret and public keys, you can set this to 'both'.                                                                                                                                                                    |
| secretApiKeyLocation | Specifies where in the request the secret API key and public API will be sent. This must be one of the defined RequestLocations (e.g., bearer, header, query, cookie).                                                                                                                                                                                                      |
| publicApiKeyLocation | Specifies where in the request the public API key will be sent. This must be one of the defined RequestLocations (e.g., bearer, header, query, cookie).                                                                                                                                                                                                                     |
| secretApiKeyName     | The name of the API secret in the request, used to identify the client's private api key. This is used only if the secret api keyLocation is not bearer. Secret api keys are used in trusted parties to access on behalf of the user to the sensitive data.                                                                                                                 |
| publicApiKeyName     | The name of the public API key in the request, used to identify the client's public access key. This is used only if the public api key location is not bearer and can be used to identify the client's public access key. Use public keys if you need to identify the client when you need to identify the client when from a frontend based access to non-sensitive data. |
