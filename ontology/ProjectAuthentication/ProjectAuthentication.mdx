...
description: Defines the authentication and authorization configuration for a Mindbricks project, including login behavior, verification flows, access control, and user and tenant properties.
---
