...
description: "Shopping cart configuration chapter. When enabled, auto-generates Cart, CartItem, and optionally Campaign/Coupon DataObjects with Redis-first architecture for hyper-scalable cart management."
---
