...
| superAdminIdentifier               | The login identifier of the super admin user. When `primaryLoginIdentifier` is `'email'` or `'emailOrMobile'`, this should be an email address. When it is `'mobile'`, this should be a mobile number in E.164 format (e.g. +905551234567). This user has full permissions across the project and is not tenant-scoped.                                                                                         |
