...
description: >-
  ...
  architectural blueprint designed by AI and fully controllable by humans.
---
...
The primary way to create and evolve a project is through the **AI Architect (Agent Ada)**, which designs the complete architecture from your natural language requirements. You can also create or edit the project manually through the visual **Mindbricks Studio** UI or directly via JSON editors—the AI and manual workflows use the same ontology and are fully interchangeable.
...
- Transformations in workflows (`AiCallAction`)
...
Whether the AI agent authors this theory from your natural language description or you craft it manually pattern by pattern, the result is the same: a bridge between abstract domain thinking and concrete, executable architecture.
