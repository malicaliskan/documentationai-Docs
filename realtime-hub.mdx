...
```json
{
  "roomSettings": {
    ...
    "authSources": [
      { "name": "eventOwner", "object": "CatalogEvent", "userField": "createdBy", "roomField": "id", "hubRole": "owner" },
      { "name": "eventHost", "object": "EventHost", "userField": "userId", "roomField": "eventId", "hubRole": "moderator" },
      { "name": "ticketHolder", "object": "IssuedTicket", "userField": "ownerUserId", "roomField": "eventId", "condition": "issuedTicket.status == 'active'", "hubRole": "attendee" }
    ],
    "authScripts": [
...
| `condition` | MScript | Optional condition evaluated on the found record. The context variable name matches the `object` name (e.g., `issuedTicket`). The generic alias `record` is also available. Example: `issuedTicket.status == 'active'`. |
...
```json
{
  ...
  "roomSettings": {
    ...
    "authSources": [
      { "name": "conversationAdmin", "object": "ConversationMember", "userField": "userId", "roomField": "conversationId", "condition": "conversationMember.role == 'admin'", "hubRole": "admin" },
      { "name": "conversationMember", "object": "ConversationMember", "userField": "userId", "roomField": "conversationId", "hubRole": "member" }
    ]
  },
  "hubRoles": [
...
```json
{
  ...
  "roomSettings": {
    ...
    "authSources": [
      { "name": "matchPlayer", "object": "MatchPlayer", "userField": "playerId", "roomField": "matchId", "hubRole": "player" }
    ]
  },
  "hubRoles": [
...
```json
{
  ...
  "roomSettings": {
    ...
    "authSources": [
      { "name": "dashboardOwner", "object": "Dashboard", "userField": "createdBy", "roomField": "id", "hubRole": "dashboardOwner" }
    ]
  },
  "hubRoles": [
...
```json
{
  ...
  "roomSettings": {
    ...
    "authSources": [
      { "name": "ticketCreator", "object": "SupportTicket", "userField": "createdBy", "roomField": "id", "hubRole": "customer" }
    ]
  },
  "hubRoles": [
