...
description: Configuration reference for defining the access control architecture of a Mindbricks project, including permissions, roles, OBAC, and ABAC settings.
---
