...
<Image src="https://blob-cdn.documentation.ai/org-39f2f004-5620-4ad2-9ba7-4e591d7735f7/doc-49f7ea0f-3aad-4d21-b3bf-699b5905ffea/1767358148751-709foojm2vn-pasted-image-1767358146123.png?q=85&fm=auto&auto=compress%2Cformat" width="1919" height="977" alt="" />
...
<Image src="https://blob-cdn.documentation.ai/org-39f2f004-5620-4ad2-9ba7-4e591d7735f7/doc-49f7ea0f-3aad-4d21-b3bf-699b5905ffea/1767358195984-p1qa1rp2xc-pasted-image-1767358193789.png?q=85&fm=auto&auto=compress%2Cformat" width="1919" height="976" alt="" />
...
<Image src="https://blob-cdn.documentation.ai/org-39f2f004-5620-4ad2-9ba7-4e591d7735f7/doc-49f7ea0f-3aad-4d21-b3bf-699b5905ffea/1767358263878-rdyibe2p9-pasted-image-1767358260378.png?q=85&fm=auto&auto=compress%2Cformat" width="1919" height="981" alt="" />
...
<Image src="https://blob-cdn.documentation.ai/org-39f2f004-5620-4ad2-9ba7-4e591d7735f7/doc-49f7ea0f-3aad-4d21-b3bf-699b5905ffea/1767358344189-jr22imv2j3k-pasted-image-1767358342328.png?q=85&fm=auto&auto=compress%2Cformat" width="1919" height="978" alt="" />
...
<Image src="https://blob-cdn.documentation.ai/org-39f2f004-5620-4ad2-9ba7-4e591d7735f7/doc-49f7ea0f-3aad-4d21-b3bf-699b5905ffea/1767358393039-k8isd17zloq-pasted-image-1767358391082.png?q=85&fm=auto&auto=compress%2Cformat" width="1919" height="972" alt="" />
...
<Image src="https://blob-cdn.documentation.ai/org-39f2f004-5620-4ad2-9ba7-4e591d7735f7/doc-49f7ea0f-3aad-4d21-b3bf-699b5905ffea/1767358459022-hi7zh0t4524-pasted-image-1767358456714.png?q=85&fm=auto&auto=compress%2Cformat" width="1919" height="980" alt="" />
...
| Property → Basic Settings       | `DataProperty.basicSettings` (`PropertyBasicSettings`) — carries `type`, `isRequired`, `isArray`, `isFilterParameter`, `enumOptions` (when `type === 'Enum'`), `defaultValue`, and the rest of the per-property flags |
| Property → Index Settings       | `DataProperty.indexSettings` (`PropertyIndexSettings`)                                      |
| Property → Relation Settings    | `DataProperty.relationSettings` (`PropertyRelation`) — block presence activates an FK relationship; flat (no `configuration` wrapper) |
| Property → Session Settings     | `DataProperty.sessionSettings` (`PropertySessionSettings`) — block presence makes the property session-bound; the framework auto-injects `session[sessionParam]` at write time |
| Property → Static Join          | `DataProperty.staticJoin` (`PropertyStaticJoin`) — block presence makes the property join-bound; the framework runs the join at write time |
| (per-API write declaration)     | System-managed values land in each create/update BusinessApi's `dataClauseItems[]` (a list of `DataMapItem`) |
...
| Request Parameters                       | `BusinessApi.requestParameters[]` (`BusinessApiParameter`) — full input shape declaration                                                          |
| Data Clause Items                        | `BusinessApi.dataClauseItems[]` (`DataMapItem`) — the per-API write map for create / update APIs                                                   |
