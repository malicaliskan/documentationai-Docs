---
title: Data property
description: Definition and configuration of data properties within Mindbricks project authentication, including basic, index, enum, relation, session, static join, formula, context, and filter settings.
---
