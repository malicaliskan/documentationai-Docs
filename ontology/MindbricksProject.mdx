...
description: Root ontology class representing the full architecture of a Mindbricks-based software project, including project settings, authentication, BFF service, notification service, and microservices.
---
# MindbricksProject
