...
description: A comprehensive guide to designing client-facing Kafka event subscriptions in Mindbricks. Covers WebSocket and SSE transports, DataObject-based authorization, topic aliases, payload transformation, mixed-access splitting, custom auth scripts, and lazy Kafka consumers.
---
