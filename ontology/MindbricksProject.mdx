---
title: "Mindbricks Project"
description: "MindbricksProject is the root class representing the entire architecture of a software project in Mindbricks. It sits at the top of the Mindbricks ontology tree—a structured, semantic pattern definiti"
---
...
| agentHub            | Centralized AI agent management hub. Generates a dedicated service that hosts AI agents with cross-service tool access, runtime reconfiguration, and optional dynamic agent creation by end-users. Agents in the hub can use tools from any service in the project. |
