...
When your `dataClause` updates array fields through generated db utilities, you can use array mutation operators (`$add`, `$rem`, `$addIf`) instead of full replacement. See [Array Mutation Syntax Guide](../../array-mutation-syntax-guide).
