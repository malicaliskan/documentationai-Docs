...
Mindbricks is an **AI-driven backend development platform** that transforms natural language requirements into **production-ready microservice architectures**.

This document explains **how applications are designed using Mindbricks’ AI-driven workflow**, from initial idea to fully specified backend architecture. It focuses on:

- How the AI agents lead the design process  
- How requirements evolve into architecture  
- How users guide and refine the AI-generated design  
- How manual customization fits into the AI-led workflow  

📋 **Manual Design Option**  
While AI-driven design is the recommended approach, Mindbricks also supports fully manual, step-by-step project design. See:  
*Building an Application in Mindbricks*.

---

## **AI-Led Design with Full Manual Control**

Mindbricks follows an **AI-first design model**:  
The AI agent leads the architecture design from natural language requirements, while you retain **full manual control** for review, refinement, and precision.
...
The AI acts as the **project development leader**, while you stay in full control of the final system.
...
When you create a new project, the **Product Manager Agent** immediately engages to understand your application requirements in depth.
