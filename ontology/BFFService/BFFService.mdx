---
title: BFF Service
description: Backend-for-Frontend service in Mindbricks that aggregates data across services using DataViews to provide optimized responses for frontend clients.
---
