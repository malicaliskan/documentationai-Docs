...
**mobile** : A string value to represent the user's mobile number. Required when the mobile field exists in the user data model (depends on `primaryLoginIdentifier` and `secondaryIdentifierPresence`).
